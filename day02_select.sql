...
-- Q2 : Meslek lisesinde kayitli ogrencilerin sadece isimlerini getirin
SELECT adres
FROM meslek_lisesi;

-- Q3 : Derecesi 90 dan yüksek olan ogrencilerin tum bilgilerini getirin.
...
-- Q5 : Adresi Ankara olan ogrecilerin isim ve derece bilgilerini listeleyin
SELECT isim, derece
FROM meslek_lisesi
WHERE adres ='Ankara';

-- Q6 : okul nosu 1005 olan ogrencinin isim ve adres bilgisini listeleyin.
SELECT isim, adres
FROM meslek_lisesi
WHERE okul_no ='1005';
...
SELECT isim
FROM meslek_lisesi
WHERE okul_no>1001 and okul_no<1005; 

-- Q7 : Derecesi70 ile 80 arasinda olan ogrencilerin okul_no ve adreslerini listeleyin.
